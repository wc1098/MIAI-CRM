...
class CrmPersonModel(ModelMixin, UserMixin):
    ...
    weight_kg: Mapped[int | None] = mapped_column(Integer, nullable=True, comment="体重kg")
    ...
    occupation_code: Mapped[str | None] = mapped_column(String(32), nullable=True, index=True, comment="标准职业")
    ...
    graduated_school: Mapped[str | None] = mapped_column(String(128), nullable=True, comment="毕业院校")
    major: Mapped[str | None] = mapped_column(String(128), nullable=True, comment="专业")
    unit_type: Mapped[str | None] = mapped_column(String(32), nullable=True, index=True, comment="单位类型")
    job_title: Mapped[str | None] = mapped_column(String(64), nullable=True, comment="职务")
    work_company: Mapped[str | None] = mapped_column(String(128), nullable=True, comment="工作单位")
    ...
    accept_long_distance_self: Mapped[bool | None] = mapped_column(Boolean, nullable=True, comment="本人是否接受异地")
    accept_flash_marriage: Mapped[bool | None] = mapped_column(Boolean, nullable=True, comment="本人是否接受闪婚")
    willing_relocate: Mapped[bool | None] = mapped_column(Boolean, nullable=True, comment="本人是否愿意搬家")
    marriage_plan: Mapped[str | None] = mapped_column(String(32), nullable=True, index=True, comment="结婚计划")
    family_background: Mapped[str | None] = mapped_column(Text, nullable=True, comment="家庭情况")
    profile_remark: Mapped[str | None] = mapped_column(Text, nullable=True, comment="档案备注")
